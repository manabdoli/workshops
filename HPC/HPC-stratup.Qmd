...
knitr::opts_chunk$set(eval = FALSE, engine = 'python')  # affects Python chunks
knitr::opts_chunk$set(eval = FALSE)  # default for all chunks
```
...
- Linear speedup: 2x cores ≈ 2x faster (ideal)
